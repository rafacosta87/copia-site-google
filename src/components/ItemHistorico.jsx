...
function ItemHistorico({ item, event }) {                                                                                                   //função recebera item que sera usado no span(l 20)
    ...
    return (
        <div                                                                                                                               //abaixo iremos alterar o estado hovered(l 9) a depender do passar do mouse
            ...
            className='flex w-full flex-row gap-5 items-center  px-5 py-1 text-[#c58af9]  hover:bg-[#3c4043]'
        >
            ...
            <div className='flex flex-row justify-between w-full'>
                ...
                {hovered &&                                                                                                                 //quando houvered for true mostrara a div e escondera quando false
                    <div
                        onClick={event}
                        className='hover:underline text-[12px] flex justify-center items-center cursor-pointer text-[#aaadb2] hover:text-[#8ab4f8]'>
                        Excluir
                    </div>
                }
            </div>
